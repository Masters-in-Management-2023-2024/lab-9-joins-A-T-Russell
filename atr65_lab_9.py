...
Original file is located at
    https://colab.research.google.com/drive/1eZyyGG88y1GVFBBeEfY04ofhpqYHlqj6
...
avg_bad_weather = trips_weather.filter(
...
hof_hits = Batting.join(
    hall_inducted, on="playerID", how="inner"
).group_by(
    "playerID"
).agg(
    pl.col("H").sum().alias("career_hits")
).select(
    pl.col("career_hits").mean().alias("average_hits")
)
